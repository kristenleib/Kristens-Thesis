...
void lambda_Au_Au_2sig_0_10() {
    ...
    TFile *outFile_gold_2sig = new TFile("gold_outputs_2sig_0_10.root", "Recreate");
    ...
    for (int i = 0; i < nEntries; ++i){
        ...
        if (eventId != prevEventID && prevEventID != -1){
            ...
            if (mcentrality >= 7 && mcentrality <= 8) {
    ...
    outFile_gold_2sig->Write();
    outFile_gold_2sig->Close();
