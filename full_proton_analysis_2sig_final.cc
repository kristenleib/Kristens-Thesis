...
void full_proton_analysis_2sig() {
    ...
    TFile *proton_output_file_2sig = new TFile("proton_output_2sig.root", "Recreate");
        ...
        if (eventId != prevEventID && prevEventID != -1){
            ...
            for (size_t j = 0; j < lambda_us.size(); ++j) {
                for (size_t k = j + 1; k < lambda_us.size(); ++k) {
                    ...
                    h2_no_cuts_L0_L0_p1pt_p2pt_US_US->Fill(proton_us[j].Pt(), proton_us[k].Pt());
                    h2_no_cuts_L0_L0_p1eta_p2eta_US_US->Fill(proton_us[j].Eta(), proton_us[k].Eta());
                    h2_no_cuts_L0_L0_p1phi_p2phi_US_US->Fill(proton_us[j].Phi(), proton_us[k].Phi());
                ...
                for (size_t k = 0; k < lambda_ls.size(); ++k) {
                    ...
                    h2_no_cuts_L0_L0_p1pt_p2pt_US_LS->Fill(proton_us[j].Pt(), proton_ls[k].Pt());
                    h2_no_cuts_L0_L0_p1eta_p2eta_US_LS->Fill(proton_us[j].Eta(), proton_ls[k].Eta());
                    h2_no_cuts_L0_L0_p1phi_p2phi_US_LS->Fill(proton_us[j].Phi(), proton_ls[k].Phi());
            ...
            for (size_t j = 0; j < lambda_us.size(); ++j) {
                for (size_t k = 0; k < lambda_bar_us.size(); ++k) {
                    ...
                    h2_no_cuts_L0_L0bar_p1pt_p2pt_US_US->Fill(proton_us[j].Pt(), anti_proton_us[k].Pt());
                    h2_no_cuts_L0_L0bar_p1eta_p2eta_US_US->Fill(proton_us[j].Eta(), anti_proton_us[k].Eta());
                    h2_no_cuts_L0_L0bar_p1phi_p2phi_US_US->Fill(proton_us[j].Phi(), anti_proton_us[k].Phi());
                ...
                for (size_t k = 0; k < lambda_bar_ls.size(); ++k){
                    ...
                    h2_no_cuts_L0_L0bar_p1pt_p2pt_US_LS->Fill(proton_us[j].Pt(), anti_proton_ls[k].Pt());
                    h2_no_cuts_L0_L0bar_p1eta_p2eta_US_LS->Fill(proton_us[j].Eta(), anti_proton_ls[k].Eta());
                    h2_no_cuts_L0_L0bar_p1phi_p2phi_US_LS->Fill(proton_us[j].Phi(), anti_proton_ls[k].Phi());
            ...
            for (size_t j = 0; j < lambda_ls.size(); ++j){
                for (size_t k = 0; k < lambda_bar_us.size(); ++k){
                    ...
                    h2_no_cuts_L0_L0bar_p1pt_p2pt_US_LS->Fill(proton_ls[j].Pt(), anti_proton_us[k].Pt());
                    h2_no_cuts_L0_L0bar_p1eta_p2eta_US_LS->Fill(proton_ls[j].Eta(), anti_proton_us[k].Eta());
                    h2_no_cuts_L0_L0bar_p1phi_p2phi_US_LS->Fill(proton_ls[j].Phi(), anti_proton_us[k].Phi());
            ...
            for (size_t j = 0; j < lambda_bar_us.size(); ++j){
                for (size_t k = j + 1; k < lambda_bar_us.size(); ++k) {
                    ...
                    h2_no_cuts_L0bar_L0bar_p1pt_p2pt_US_US->Fill(anti_proton_us[j].Pt(), anti_proton_us[k].Pt());
                    h2_no_cuts_L0bar_L0bar_p1eta_p2eta_US_US->Fill(anti_proton_us[j].Eta(), anti_proton_us[k].Eta());
                    h2_no_cuts_L0bar_L0bar_p1phi_p2phi_US_US->Fill(anti_proton_us[j].Phi(), anti_proton_us[k].Phi());
                ...
                for (size_t k = 0; k < lambda_bar_ls.size(); ++k) {
                    ...
                    if (iter_2 % 2 == 0){
                        ...
                        h2_lambda_bar_us_lambda_bar_ls->Fill(lambda_bar_ls[k].M(), lambda_bar_us[k].M());
                    }

                    h2_no_cuts_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(anti_proton_us[j].Pt(), anti_proton_ls[k].Pt());
                    h2_no_cuts_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(anti_proton_us[j].Eta(), anti_proton_ls[k].Eta());
                    h2_no_cuts_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(anti_proton_us[j].Phi(), anti_proton_ls[k].Phi());
            ...
            if (lambda_us.size() > 0 && lambda_bar_us.size() > 0 && same_event_lambda_us_4.size() < vector_size) {
                if (proton_id_lambda_us[0] != anti_proton_id_lambda_bar_us[0] && pion_id_lambda_us[0] != anti_pion_id_lambda_bar_us[0]) {
                    ...
                    h2_restricted_L0_L0bar_p1pt_p2pt_US_US->Fill(proton_us[0].Pt(), anti_proton_us[0].Pt());
                    h2_restricted_L0_L0bar_p1eta_p2eta_US_US->Fill(proton_us[0].Eta(), anti_proton_us[0].Eta());
                    h2_restricted_L0_L0bar_p1phi_p2phi_US_US->Fill(proton_us[0].Phi(), anti_proton_us[0].Phi());
            ...
            if (lambda_us.size() > 0 && lambda_bar_ls.size() > 0 && same_event_lambda_us_5.size() < vector_size) {
                if (proton_id_lambda_us[0] != anti_proton_id_lambda_bar_ls[0] && pion_id_lambda_us[0] != anti_pion_id_lambda_bar_ls[0]) {
                    ...
                    h2_restricted_L0_L0bar_p1pt_p2pt_US_LS->Fill(proton_us[0].Pt(), anti_proton_ls[0].Pt());
                    h2_restricted_L0_L0bar_p1eta_p2eta_US_LS->Fill(proton_us[0].Eta(), anti_proton_ls[0].Eta());
                    h2_restricted_L0_L0bar_p1phi_p2phi_US_LS->Fill(proton_us[0].Phi(), anti_proton_ls[0].Phi());
    ...
    double Total_counts_SE_L0_L0 = Counts_SE_US_US_LL + Counts_SE_US_LS_LL;
    double Total_counts_SE_L0_L0bar = Counts_SE_US_US_LLBar + Counts_SE_US_LS_LLBar;
    double Total_counts_SE_L0bar_L0bar = Counts_SE_US_US_LBarLBar + Counts_SE_US_LS_LBarLBar;

    cout << "   " << endl;
    cout << "Total Counts L0_L0 Pairs: " << Total_counts_SE_L0_L0 << endl;
    cout << "Total Counts L0_L0bar Pairs: " << Total_counts_SE_L0_L0bar << endl;
    cout << "Total Counts L0bar_L0bar Pairs: " << Total_counts_SE_L0bar_L0bar << endl;

    double total_counts_1 = Total_counts_SE_L0_L0 + Total_counts_SE_L0_L0bar + Total_counts_SE_L0bar_L0bar;

    cout << "   " << endl;
    cout << "Total Counts: " << total_counts_1 << endl;
    cout << "   " << endl;

    gStyle->SetPalette(kPastel);
    gStyle->SetOptStat(0);

    //2d Invariant Mass Plots (before background subtraction)
    ...
    // h2_lambda_us_lambda_bar_us->Draw("COLZ");
    h2_lambda_us_lambda_bar_us->SetTitle("2d Invariant Mass for L0_L0bar Pair (Signal with Background)");
    ...
    h2_lambda_us_lambda_us->SetTitle("2d Invariant Mass for L0_L0 Pair (Singal with Background)");
    ...
    h2_lambda_bar_us_lambda_bar_us->SetTitle("2d Invariant Mass for L0bar_L0bar Pair (Signal with Background)");
    ...
    h2_LLBar_Signal->SetTitle("2d Invariant Mass for L0_L0bar Pair (Signal)");
    ...
    gaus2D_LLBar->SetTitle("Gaussian fit for L0_L0bar Pairs");
    ...
    h2_LL_Signal->SetTitle("2d Invariant Mass for L0_L0 Pair (Signal)");
    ...
    // h2_LL_Signal->Fit("gaus2D_LL", "0", "", min, max);
    ...
    gaus2D_LL->SetTitle("Gaussian fit for L0_L0 Pairs");
    ...
    h2_LBarLBar_Signal->SetTitle("2d Invariant Mass for L0bar_L0bar Pair (Signal)");
    ...
    gaus2D_LBarLBar->SetTitle("Gaussian fit for L0bar_L0bar Pairs");
    ...
    double Total_counts_SE_signal = counts_no_cuts_L0_L0_signal + counts_no_cuts_L0_L0bar_signal + counts_no_cuts_L0bar_L0bar_signal;

    cout << "   " << endl;
    cout << "Total Counts for the Signal (no cuts): " << Total_counts_SE_signal << endl;
    cout << "   " << endl;
    ...
    h2_no_cuts_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0 Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0 Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar_L0bar Pairs (no cuts)");
    ...
    std::unique_ptr<TCanvas> c6(new TCanvas("c6", "c6- 2D Inv. Mass Projections", 1800, 900));
    c6->Divide(3, 2);
    ...
    h2_SE_lambda_us_lambda_bar_us->SetTitle("2d Invariant Mass for L0_L0bar Pairs (Singal + Background, restricted vectors)");
    ...
    h2_SE_lambda_us_lambda_us->SetTitle("2d Invariant Mass for L0_L0 Pairs (Singal + Background, restricted vectors)");
    ...
    h2_SE_lambda_bar_us_lambda_bar_us->SetTitle("2d Invariant Mass for L0bar_L0bar Pairs (Singal + Background, restricted vectors)");
    ...
    h2_restricted_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US_US L0-L0bar Pairs (restricted vectors)");
    
    c8->cd(2);
    h2_restricted_L0_L0bar_p1eta_p2eta_US_US->Draw("COLZ");
    h2_restricted_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US_US L0-L0bar Pairs (restricted vectors)");

    c8->cd(3);
    h2_restricted_L0_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_restricted_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US_US L0-L0bar Pairs (restricted vectors)");

    c8->cd(4);
    h2_restricted_L0_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_restricted_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US_LS L0-L0bar Pairs (restricted vectors)");
    
    c8->cd(5);
    h2_restricted_L0_L0bar_p1eta_p2eta_US_LS->Draw("COLZ");
    h2_restricted_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US_LS L0-L0bar Pairs (restricted vectors)");

    c8->cd(6);
    h2_restricted_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_restricted_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US_LS L0-L0bar Pairs (restricted vectors)");
    ...
    h2_restricted_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US_US L0-L0 Pairs (restricted vectors)");

    c9->cd(2);
    h2_restricted_L0_L0_p1eta_p2eta_US_US->Draw("COLZ");
    h2_restricted_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US_US L0-L0 Pairs (restricted vectors)");

    c9->cd(3);
    h2_restricted_L0_L0_p1phi_p2phi_US_US->Draw("COLZ");
    h2_restricted_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US_US L0-L0 Pairs (restricted vectors)");

    c9->cd(4);
    h2_restricted_L0_L0_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_restricted_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US_LS L0-L0 Pairs (restricted vectors)");

    c9->cd(5);
    h2_restricted_L0_L0_p1eta_p2eta_US_LS->Draw("COLZ");
    h2_restricted_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US_LS L0-L0 Pairs (restricted vectors)");

    c9->cd(6);
    h2_restricted_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_restricted_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US_LS L0-L0 Pairs (restricted vectors)");
    ...
    h2_restricted_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US_US L0bar-L0bar Pairs (restricted vectors)");
    
    c10->cd(2);
    h2_restricted_L0bar_L0bar_p1eta_p2eta_US_US->Draw("COLZ");
    h2_restricted_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US_US L0bar-L0bar Pairs (restricted vectors)");

    c10->cd(3);
    h2_restricted_L0bar_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_restricted_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US_US L0bar-L0bar Pairs (restricted vectors)");

    c10->cd(4);
    h2_restricted_L0bar_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_restricted_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US_LS L0bar-L0bar Pairs (restricted vectors)");
    
    c10->cd(5);
    h2_restricted_L0bar_L0bar_p1eta_p2eta_US_LS->Draw("COLZ");
    h2_restricted_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US_LS L0bar-L0bar Pairs (restricted vectors)");

    c10->cd(6);
    h2_restricted_L0bar_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_restricted_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US_LS L0bar-L0bar Pairs (restricted vectors)");
    ...
    h2_restricted_LLBar_Signal->SetTitle("inv. mass L0-L0bar signal");
    ...
    h2_restricted_LL_Signal->SetTitle("inv. mass L0-L0 signal");
    ...
    h2_restricted_LBarLBar_Signal->SetTitle("inv. mass L0bar-L0bar signal");
    ...
    double minX_range_LLBar_2 = meanX_LLBar_2 - 2.0 * sigmaX_LLBar_2;
    double maxX_range_LLBar_2 = meanX_LLBar_2 + 2.0 * sigmaX_LLBar_2;
    double minY_range_LLBar_2 = meanY_LLBar_2 - 2.0 * sigmaY_LLBar_2;
    double maxY_range_LLBar_2 = meanY_LLBar_2 + 2.0 * sigmaY_LLBar_2;
    ...
    for (size_t i = 0; i < fourmoment_lambda_us4.size(); ++i){
        ...
        h2_no_cut_invMass_lambda_us_lambda_bar_us->Fill(invariantMass_lambda_us_4, invariantMass_lambda_bar_us_4);

        h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_proton_us4[i].Pt(), fourmoment_anti_proton_us4[i].Pt());
        h2_no_cut_check_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_proton_us4[i].Eta(), fourmoment_anti_proton_us4[i].Eta());
        h2_no_cut_check_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_proton_us4[i].Phi(), fourmoment_anti_proton_us4[i].Phi());
        ...
        if (invariantMass_lambda_us_4 >= minX_range_LLBar_2 && invariantMass_lambda_us_4 <= maxX_range_LLBar_2 &&
            ...
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_us_lambda_bar_us->Fill(invariantMass_lambda_us_4, invariantMass_lambda_bar_us_4);

                h2_cut_outside_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_proton_us4[i].Pt(), fourmoment_anti_proton_us4[i].Pt());
                h2_cut_outside_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_proton_us4[i].Eta(), fourmoment_anti_proton_us4[i].Eta());
                h2_cut_outside_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_proton_us4[i].Phi(), fourmoment_anti_proton_us4[i].Phi());
                ...
                h_outside_cos_theta_star3->Fill(outside_cos_theta_star3);

            } else{
                h2_invMass_lambda_us_lambda_bar_us->Fill(invariantMass_lambda_us_4, invariantMass_lambda_bar_us_4);

                h2_cut_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_proton_us4[i].Pt(), fourmoment_anti_proton_us4[i].Pt());
                h2_cut_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_proton_us4[i].Eta(), fourmoment_anti_proton_us4[i].Eta());
                h2_cut_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_proton_us4[i].Phi(), fourmoment_anti_proton_us4[i].Phi());
    ...
    for (size_t i = 0; i < fourmoment_lambda_us5.size(); ++i){
        ...
        h2_no_cut_invMass_lambda_us_lambda_bar_ls->Fill(invariantMass_lambda_us_5, invariantMass_lambda_bar_ls_5);

        h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us5[i].Pt(), fourmoment_anti_proton_ls5[i].Pt());
        h2_no_cut_check_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us5[i].Eta(), fourmoment_anti_proton_ls5[i].Eta());
        h2_no_cut_check_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us5[i].Phi(), fourmoment_anti_proton_ls5[i].Phi());
        ...
        if (invariantMass_lambda_us_5 >= minX_range_LLBar_2 && invariantMass_lambda_us_5 <= maxX_range_LLBar_2 &&
            ...
            double delta_R_Threshold = 0.93;
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_us_lambda_bar_ls->Fill(invariantMass_lambda_us_5, invariantMass_lambda_bar_ls_5);

                h2_cut_outside_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us5[i].Pt(), fourmoment_anti_proton_ls5[i].Pt());
                h2_cut_outside_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us5[i].Eta(), fourmoment_anti_proton_ls5[i].Eta());
                h2_cut_outside_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us5[i].Phi(), fourmoment_anti_proton_ls5[i].Phi());
                ...
                h_outside_cos_theta_star4->Fill(outside_cos_theta_star4);

            } else{
                h2_invMass_lambda_us_lambda_bar_ls->Fill(invariantMass_lambda_us_5, invariantMass_lambda_bar_ls_5);

                h2_cut_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us5[i].Pt(), fourmoment_anti_proton_ls5[i].Pt());
                h2_cut_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us5[i].Eta(), fourmoment_anti_proton_ls5[i].Eta());
                h2_cut_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us5[i].Phi(), fourmoment_anti_proton_ls5[i].Phi());
    ...
    for (size_t i = 0; i < fourmoment_lambda_ls6.size(); ++i){
        ...
        h2_no_cut_invMass_lambda_us_lambda_bar_ls->Fill(invariantMass_lambda_ls_6, invariantMass_lambda_bar_us_6);

        h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_ls6[i].Pt(), fourmoment_anti_proton_us6[i].Pt());
        h2_no_cut_check_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_ls6[i].Eta(), fourmoment_anti_proton_us6[i].Eta());
        h2_no_cut_check_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_ls6[i].Phi(), fourmoment_anti_proton_us6[i].Phi());
        ...
        if (invariantMass_lambda_ls_6 >= minX_range_LLBar_2 && invariantMass_lambda_ls_6 <= maxX_range_LLBar_2 &&
            ...
            double delta_R_Threshold = 0.93;
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_us_lambda_bar_ls->Fill(invariantMass_lambda_ls_6, invariantMass_lambda_bar_us_6);

                h2_cut_outside_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_ls6[i].Pt(), fourmoment_anti_proton_us6[i].Pt());
                h2_cut_outside_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_ls6[i].Eta(), fourmoment_anti_proton_us6[i].Eta());
                h2_cut_outside_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_ls6[i].Phi(), fourmoment_anti_proton_us6[i].Phi());
                ...
                h2_cut_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_proton_ls6[i].Pt(), fourmoment_anti_proton_us6[i].Pt());
                h2_cut_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_proton_ls6[i].Eta(), fourmoment_anti_proton_us6[i].Eta());
                h2_cut_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_proton_ls6[i].Phi(), fourmoment_anti_proton_us6[i].Phi());
    ...
    double minX_range_LL_2 = meanX_LL_2 - 2.0 * sigmaX_LL_2;
    double maxX_range_LL_2 = meanX_LL_2 + 2.0 * sigmaX_LL_2;
    double minY_range_LL_2 = meanY_LL_2 - 2.0 * sigmaY_LL_2;
    double maxY_range_LL_2 = meanY_LL_2 + 2.0 * sigmaY_LL_2;
    ...
    for (size_t i = 0; i < fourmoment_lambda_us_1.size(); ++i) {
        ...
        h2_no_cut_invMass_lambda_us_lambda_us->Fill(invariantMass_lambda_us_1, invariantMass_lambda_us_2);

        h2_no_cut_check_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_proton_us_1[i].Pt(), fourmoment_proton_us_2[i].Pt());
        h2_no_cut_check_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_proton_us_1[i].Eta(), fourmoment_proton_us_2[i].Eta());
        h2_no_cut_check_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_proton_us_1[i].Phi(), fourmoment_proton_us_2[i].Phi());
        ...
        if (invariantMass_lambda_us_1 >= minX_range_LL_2 && invariantMass_lambda_us_1 <= maxX_range_LL_2 &&
            ...
            double delta_R_Threshold = 0.93;
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_us_lambda_us->Fill(invariantMass_lambda_us_1, invariantMass_lambda_us_2);

                h2_cut_outside_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_proton_us_1[i].Pt(), fourmoment_proton_us_2[i].Pt());
                h2_cut_outside_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_proton_us_1[i].Eta(), fourmoment_proton_us_2[i].Eta());
                h2_cut_outside_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_proton_us_1[i].Phi(), fourmoment_proton_us_2[i].Phi());
                ...
                h_outside_cos_theta_star->Fill(outside_cos_theta_star);

            } else {
                h2_invMass_lambda_us_lambda_us->Fill(invariantMass_lambda_us_1, invariantMass_lambda_us_2);

                h2_cut_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_proton_us_1[i].Pt(), fourmoment_proton_us_2[i].Pt());
                h2_cut_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_proton_us_1[i].Eta(), fourmoment_proton_us_2[i].Eta());
                h2_cut_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_proton_us_1[i].Phi(), fourmoment_proton_us_2[i].Phi());
    ...
    for (size_t i = 0; i < fourmoment_lambda_us3.size(); ++i){
        ...
        h2_no_cut_invMass_lambda_us_lambda_ls->Fill(invariantMass_lambda_us_3, invariantMass_lambda_ls_3);

        h2_no_cut_check_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us3[i].Pt(), fourmoment_proton_ls3[i].Pt());
        h2_no_cut_check_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us3[i].Eta(), fourmoment_proton_ls3[i].Eta());
        h2_no_cut_check_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us3[i].Phi(), fourmoment_proton_ls3[i].Phi());
        ...
        if (invariantMass_lambda_us_3 >= minX_range_LL_2 && invariantMass_lambda_us_3 <= maxX_range_LL_2 &&
            ...
            double delta_R_Threshold = 0.93;
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_us_lambda_ls->Fill(invariantMass_lambda_us_3, invariantMass_lambda_ls_3);

                h2_cut_outside_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us3[i].Pt(), fourmoment_proton_ls3[i].Pt());
                h2_cut_outside_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us3[i].Eta(), fourmoment_proton_ls3[i].Eta());
                h2_cut_outside_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us3[i].Phi(), fourmoment_proton_ls3[i].Phi());
                ...
                h_outside_cos_theta_star2->Fill(outside_cos_theta_star2);

            } else{
                h2_invMass_lambda_us_lambda_ls->Fill(invariantMass_lambda_us_3, invariantMass_lambda_ls_3);

                h2_cut_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_proton_us3[i].Pt(), fourmoment_proton_ls3[i].Pt());
                h2_cut_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_proton_us3[i].Eta(), fourmoment_proton_ls3[i].Eta());
                h2_cut_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_proton_us3[i].Phi(), fourmoment_proton_ls3[i].Phi());
    ...
    double minX_range_LBarLBar_2 = meanX_LBarLBar_2 - 2.0 * sigmaX_LBarLBar_2;
    double maxX_range_LBarLBar_2 = meanX_LBarLBar_2 + 2.0 * sigmaX_LBarLBar_2;
    double minY_range_LBarLBar_2 = meanY_LBarLBar_2 - 2.0 * sigmaY_LBarLBar_2;
    double maxY_range_LBarLBar_2 = meanY_LBarLBar_2 + 2.0 * sigmaY_LBarLBar_2;
    ...
    for (size_t i=0; i < fourmoment_lambda_bar_us_1.size(); ++i) {
        ...
        h2_no_cut_invMass_lambda_bar_us_lambda_bar_us->Fill(invariantMass_lambda_bar_us_1, invariantMass_lambda_bar_us_2);

        h2_no_cut_check_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_anti_proton_us_1[i].Pt(), fourmoment_anti_proton_us_2[i].Pt());
        h2_no_cut_check_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_anti_proton_us_1[i].Eta(), fourmoment_anti_proton_us_2[i].Eta());
        h2_no_cut_check_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_anti_proton_us_1[i].Phi(), fourmoment_anti_proton_us_2[i].Phi());
        ...
        if (invariantMass_lambda_bar_us_1 >= minX_range_LBarLBar_2 && invariantMass_lambda_bar_us_1 <= maxX_range_LBarLBar_2 &&
            ...
            double delta_R_Threshold = 0.93;
            if (delta_R > delta_R_Threshold) {
                h2_invMass_outside_lambda_bar_us_lambda_bar_us->Fill(invariantMass_lambda_bar_us_1, invariantMass_lambda_bar_us_2);

                h2_cut_outside_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_anti_proton_us_1[i].Pt(), fourmoment_anti_proton_us_2[i].Pt());
                h2_cut_outside_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_anti_proton_us_1[i].Eta(), fourmoment_anti_proton_us_2[i].Eta());
                h2_cut_outside_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_anti_proton_us_1[i].Phi(), fourmoment_anti_proton_us_2[i].Phi());
                ...
                h_outside_cos_theta_star5->Fill(outside_cos_theta_star5);
            } else{
                h2_invMass_lambda_bar_us_lambda_bar_us->Fill(invariantMass_lambda_bar_us_1, invariantMass_lambda_bar_us_2);

                h2_cut_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_anti_proton_us_1[i].Pt(), fourmoment_anti_proton_us_2[i].Pt());
                h2_cut_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_anti_proton_us_1[i].Eta(), fourmoment_anti_proton_us_2[i].Eta());
                h2_cut_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_anti_proton_us_1[i].Phi(), fourmoment_anti_proton_us_2[i].Phi());
    ...
    for (size_t i = 0; i < fourmoment_lambda_bar_us7.size(); ++i) {
        ...
        h2_no_cut_invMass_lambda_bar_us_lambda_bar_ls->Fill(invariantMass_lambda_bar_us_7, invariantMass_lambda_bar_ls_7);

        h2_no_cut_check_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_anti_proton_us7[i].Pt(), fourmoment_anti_proton_ls7[i].Pt());
        h2_no_cut_check_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_anti_proton_us7[i].Eta(), fourmoment_anti_proton_ls7[i].Eta());
        h2_no_cut_check_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_anti_proton_us7[i].Phi(), fourmoment_anti_proton_ls7[i].Phi());
        ...
        if (invariantMass_lambda_bar_us_7 >= minX_range_LBarLBar_2 && invariantMass_lambda_bar_us_7 <= maxX_range_LBarLBar_2 &&
            ...
            double delta_R_Threshold = 0.93; 
            if (delta_R > delta_R_Threshold){
                h2_invMass_outside_lambda_bar_us_lambda_bar_ls->Fill(invariantMass_lambda_bar_us_7, invariantMass_lambda_bar_ls_7);

                h2_cut_outside_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_anti_proton_us7[i].Pt(), fourmoment_anti_proton_ls7[i].Pt());
                h2_cut_outside_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_anti_proton_us7[i].Eta(), fourmoment_anti_proton_ls7[i].Eta());
                h2_cut_outside_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_anti_proton_us7[i].Phi(), fourmoment_anti_proton_ls7[i].Phi());
                ...
                h_outside_cos_theta_star6->Fill(outside_cos_theta_star6);
            } else{
                h2_invMass_lambda_bar_us_lambda_bar_ls->Fill(invariantMass_lambda_bar_us_7, invariantMass_lambda_bar_ls_7);

                h2_cut_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_anti_proton_us7[i].Pt(), fourmoment_anti_proton_ls7[i].Pt());
                h2_cut_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_anti_proton_us7[i].Eta(), fourmoment_anti_proton_ls7[i].Eta());
                h2_cut_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_anti_proton_us7[i].Phi(), fourmoment_anti_proton_ls7[i].Phi());
    ...
    // Canvas 5: Angular Distribution of the Signal with Fit
    std::unique_ptr<TCanvas> c13(new TCanvas("c13", "Canvas 13", 1800, 900));
    c13->Divide(3, 2);

    c13->cd(1);
    h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_US->Draw("COLZ");
    h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0bar Pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0bar paris (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0bar pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0bar Pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0bar paris (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0bar pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0 Pairs (no cut check)");
    ...
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0 Pairs (no cut check)");
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_eta");
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p2_eta");

    c14->cd(3);
    h2_no_cut_check_L0_L0_p1phi_p2phi_US_US->Draw("COLZ");
    h2_no_cut_check_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0 Pairs (no cut check)");
    ...
    h2_no_cut_check_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0 Pairs (no cut check)");
    ...
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0 Pairs (no cut check)");
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_eta");
    h2_no_cut_check_L0_L0_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p2_eta");

    c14->cd(6);
    h2_no_cut_check_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_no_cut_check_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0 Pairs (no cut check)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar_L0bar Pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar_L0bar paris (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar_L0bar pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar_L0bar Pairs (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0bar_L0bar paris (check on pairs with no cuts)");
    ...
    h2_no_cut_check_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar_L0bar pairs (check on pairs with no cuts)");
    ...
    // h_cos_theta_star5->Scale(ridge_L0bar_L0bar_us_us);
    ...
    double P_ll_3 = B3_signle_events /= constant_value;
    std::cout << "Polarization (US-US LLbar): " << P_ll_3 << std::endl;

    double P_ll_4 = B4_signle_events /= constant_value;
    ...
    double P_ll_1 = B1_signle_events /= constant_value;
    std::cout << "Polarization (US-US LL): " << P_ll_1 << std::endl;

    double P_ll_2 = B2_signle_events /= constant_value;
    ...
    double P_ll_5 = B5_signle_events /= constant_value;
    std::cout << "Polarization (US-US LbarLbar): " << P_ll_5 << std::endl;

    double P_ll_6 = B6_signle_events /= constant_value;
    ...
    h2_cut_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0 inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0 inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0-L0 inside #DeltaR = 0.93");
    ...
    h2_cut_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0-L0 inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar-L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar-L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0bar-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar-L0bar inside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0 outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0 outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0-L0 outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0-L0 outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar-L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar-L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0bar-L0bar outside #DeltaR = 0.93");
    ...
    h2_cut_outside_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar-L0bar outside #DeltaR = 0.93");
    ...
    h2_recombined_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0bar_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0bar_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c23->cd(3);
    h2_recombined_L0_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c23->cd(4);
    h2_recombined_L0_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0bar_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0bar_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c23->cd(6);
    h2_recombined_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");
    ...
    h2_recombined_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c24->cd(3);
    h2_recombined_L0_L0_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c24->cd(4);
    h2_recombined_L0_L0_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0 Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c24->cd(6);
    h2_recombined_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0_L0_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0_L0_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");
    ...
    h2_recombined_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c25->cd(3);
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c25->cd(4);
    h2_recombined_L0bar_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0bar_L0bar_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c25->cd(6);
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_L0bar_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");
    ...
    for (size_t j = 0; j < same_event_lambda_us_1.size(); ++j) {
        for (size_t k = 0; k < single_lambda_us.size(); ++k) {
            ...
            h2_no_cuts_ME_L0_L0_p1pt_p2pt_US_US->Fill(same_event_proton_us_1[j].Pt(), single_proton_us[k].Pt());
            h2_no_cuts_ME_L0_L0_p1eta_p2eta_US_US->Fill(same_event_proton_us_1[j].Eta(), single_proton_us[k].Eta());
            h2_no_cuts_ME_L0_L0_p1phi_p2phi_US_US->Fill(same_event_proton_us_1[j].Phi(), single_proton_us[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_us_3.size(); ++j) {
        for (size_t k = 0; k < single_lambda_ls.size(); ++k) {       
            ...
            h2_no_cuts_ME_L0_L0_p1pt_p2pt_US_LS->Fill(same_event_proton_us_3[j].Pt(), single_proton_ls[k].Pt());
            h2_no_cuts_ME_L0_L0_p1eta_p2eta_US_LS->Fill(same_event_proton_us_3[j].Eta(), single_proton_ls[k].Eta());
            h2_no_cuts_ME_L0_L0_p1phi_p2phi_US_LS->Fill(same_event_proton_us_3[j].Phi(), single_proton_ls[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_us_4.size(); ++j) {
        for (size_t k = 0; k < single_lambda_bar_us.size(); ++k){
            ...
            h2_no_cuts_ME_L0_L0bar_p1pt_p2pt_US_US->Fill(same_event_proton_us_4[j].Pt(), single_anti_proton_us[k].Pt());
            h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_US->Fill(same_event_proton_us_4[j].Eta(), single_anti_proton_us[k].Eta());
            h2_no_cuts_ME_L0_L0bar_p1phi_p2phi_US_US->Fill(same_event_proton_us_4[j].Phi(), single_anti_proton_us[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_us_5.size(); ++j) {
        for (size_t k = 0; k < single_lambda_bar_ls.size(); ++k) {
            ...
            h2_no_cuts_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(same_event_proton_us_5[j].Pt(), anti_proton_ls[k].Pt());
            h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(same_event_proton_us_5[j].Eta(), anti_proton_ls[k].Eta());
            h2_no_cuts_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(same_event_proton_us_5[j].Phi(), anti_proton_ls[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_ls_5.size(); ++j) {
        for (size_t k = 0; k < single_lambda_bar_us.size(); ++k) {
            ...
            h2_no_cuts_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(same_event_proton_ls_5[j].Pt(), single_anti_proton_us[k].Pt());
            h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(same_event_proton_ls_5[j].Eta(), single_anti_proton_us[k].Eta());
            h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(same_event_proton_ls_5[j].Phi(), single_anti_proton_us[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_bar_us_1.size(); ++j) {
        for (size_t k = 0; k < single_lambda_bar_us.size(); ++k) {
            ...
            h2_no_cuts_ME_L0bar_L0bar_p1pt_p2pt_US_US->Fill(same_event_anti_proton_us_1[j].Pt(), single_anti_proton_us[k].Pt());
            h2_no_cuts_ME_L0bar_L0bar_p1eta_p2eta_US_US->Fill(same_event_anti_proton_us_1[j].Eta(), single_anti_proton_us[k].Eta());
            h2_no_cuts_ME_L0bar_L0bar_p1phi_p2phi_US_US->Fill(same_event_anti_proton_us_1[j].Phi(), single_anti_proton_us[k].Phi());
    ...
    for (size_t j = 0; j < same_event_lambda_bar_us_6.size(); ++j) {
        for (size_t k = 0; k < single_lambda_bar_ls.size(); ++k) {
            ...
            h2_no_cuts_ME_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(same_event_anti_proton_us_6[j].Pt(), single_anti_proton_ls[k].Pt());
            h2_no_cuts_ME_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(same_event_anti_proton_us_6[j].Eta(), single_anti_proton_ls[k].Eta());
            h2_no_cuts_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(same_event_anti_proton_us_6[j].Phi(), single_anti_proton_ls[k].Phi());
    ...
    mixed_event_SE_lambda_us_S_lambda_bar_us->SetTitle("Lambda - Lambda Bar Pair Signal (ME)");
    ...
    mixed_event_SE_lambda_us_S_lambda_us->SetTitle("Lambda - Lambda Pair Signal (ME)");
    ...
    mixed_event_SE_lambda_bar_us_S_lambda_bar_us->SetTitle("Lambda - Lambda Bar Pair Signal (ME)");
    ...
    h2_no_cuts_ME_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0_L0 Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0_L0 Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0 Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar_L0bar Pairs (no cuts)"); 
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS L0bar_L0bar Pairs (no cuts)");
    ...
    h2_no_cuts_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar_L0bar Pairs (no cuts)");
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_us_4.size(); ++i){
        ...
        h2_no_cut_invMass_ME_lambda_us_lambda_bar_us->Fill(fourmoment_ME_lambda_us_4[i].M(), fourmoment_ME_lambda_bar_us_4[i].M(), weight_3);

        h2_no_cut_check_ME_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_proton_us_4[i].Pt(), fourmoment_ME_anti_proton_us_4[i].Pt(), weight_3);
        h2_no_cut_check_ME_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_proton_us_4[i].Eta(), fourmoment_ME_anti_proton_us_4[i].Eta(), weight_3);
        h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_proton_us_4[i].Phi(), fourmoment_ME_anti_proton_us_4[i].Phi(), weight_3);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_us_lambda_bar_us->Fill(fourmoment_ME_lambda_us_4[i].M(), fourmoment_ME_lambda_bar_us_4[i].M(), weight_3);

            h2_cut_outside_ME_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_proton_us_4[i].Pt(), fourmoment_ME_anti_proton_us_4[i].Pt(), weight_3);
            h2_cut_outside_ME_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_proton_us_4[i].Eta(), fourmoment_ME_anti_proton_us_4[i].Eta(), weight_3);
            h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_proton_us_4[i].Phi(), fourmoment_ME_anti_proton_us_4[i].Phi(), weight_3);
            ...
            h_outside_ME_cos_theta_star3->Fill(outside_ME_cos_theta_star3, weight_3); 
        } else{
            h2_invMass_ME_lambda_us_lambda_bar_us->Fill(fourmoment_ME_lambda_us_4[i].M(), fourmoment_ME_lambda_bar_us_4[i].M(), weight_3);

            h2_cut_ME_L0_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_proton_us_4[i].Pt(), fourmoment_ME_anti_proton_us_4[i].Pt(), weight_3);
            h2_cut_ME_L0_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_proton_us_4[i].Eta(), fourmoment_ME_anti_proton_us_4[i].Eta(), weight_3);
            h2_cut_ME_L0_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_proton_us_4[i].Phi(), fourmoment_ME_anti_proton_us_4[i].Phi(), weight_3);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_us_5.size(); ++i) {
        ...
        h2_no_cut_invMass_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_us_5[i].M(), fourmoment_ME_lambda_bar_ls_5[i].M(), weight_4);

        h2_no_cut_check_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_5[i].Pt(), fourmoment_ME_anti_proton_ls_5[i].Pt(), weight_4);
        h2_no_cut_check_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_5[i].Eta(), fourmoment_ME_anti_proton_ls_5[i].Eta(), weight_4);
        h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Phi(), fourmoment_ME_anti_proton_ls_5[i].Phi(), weight_4);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_us_5[i].M(), fourmoment_ME_lambda_bar_ls_5[i].M(), weight_4);

            h2_cut_outside_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_5[i].Pt(), fourmoment_ME_anti_proton_ls_5[i].Pt(), weight_4);
            h2_cut_outside_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_5[i].Eta(), fourmoment_ME_anti_proton_ls_5[i].Eta(), weight_4);
            h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Phi(), fourmoment_ME_anti_proton_ls_5[i].Phi(), weight_4);
            ...
            h_outside_ME_cos_theta_star4->Fill(outside_ME_cos_theta_star4, weight_4);
        } else{
            h2_invMass_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_us_5[i].M(), fourmoment_ME_lambda_bar_ls_5[i].M(), weight_4);

            h2_cut_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_5[i].Pt(), fourmoment_ME_anti_proton_ls_5[i].Pt(), weight_4);
            h2_cut_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_5[i].Eta(), fourmoment_ME_anti_proton_ls_5[i].Eta(), weight_4);
            h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Phi(), fourmoment_ME_anti_proton_ls_5[i].Phi(), weight_4);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_ls_5.size(); ++i) {
        ...
        h2_no_cut_invMass_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_ls_5[i].M(), fourmoment_ME_lambda_bar_us_5[i].M(), weight_5);

        h2_no_cut_check_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Pt(), fourmoment_ME_anti_proton_us_5[i].Pt(), weight_5);
        h2_no_cut_check_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Eta(), fourmoment_ME_anti_proton_us_5[i].Eta(), weight_5);
        h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Phi(), fourmoment_ME_anti_proton_us_5[i].Phi(), weight_5);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_ls_5[i].M(), fourmoment_ME_lambda_bar_us_5[i].M(), weight_5);

            h2_cut_outside_ME_L0_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Pt(), fourmoment_ME_anti_proton_us_5[i].Pt(), weight_5);
            h2_cut_outside_ME_L0_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Eta(), fourmoment_ME_anti_proton_us_5[i].Eta(), weight_5);
            h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_ls_5[i].Phi(), fourmoment_ME_anti_proton_us_5[i].Phi(), weight_5);
            ...
            h_outside_ME_cos_theta_star4->Fill(outside_ME_cos_theta_star4, weight_5);           
        } else{
            h2_invMass_ME_lambda_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_ls_5[i].M(), fourmoment_ME_lambda_bar_us_5[i].M(), weight_5);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_us_1.size(); ++i) {
        ...
        h2_no_cut_invMass_ME_lambda_us_lambda_us->Fill(fourmoment_ME_lambda_us_1[i].M(), fourmoment_ME_lambda_us_2[i].M(), weight_1);

        h2_no_cut_check_ME_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_ME_proton_us_1[i].Pt(), fourmoment_ME_proton_us_2[i].Pt(), weight_1);
        h2_no_cut_check_ME_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_ME_proton_us_1[i].Eta(), fourmoment_ME_proton_us_2[i].Eta(), weight_1);
        h2_no_cut_check_ME_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_ME_proton_us_1[i].Phi(), fourmoment_ME_proton_us_2[i].Phi(), weight_1);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_us_lambda_us->Fill(fourmoment_ME_lambda_us_1[i].M(), fourmoment_ME_lambda_us_2[i].M(), weight_1);

            h2_cut_outside_ME_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Pt(), fourmoment_ME_anti_proton_us_2[i].Pt(), weight_1);
            h2_cut_outside_ME_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Eta(), fourmoment_ME_anti_proton_us_2[i].Eta(), weight_1);
            h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Phi(), fourmoment_ME_anti_proton_us_2[i].Phi(), weight_1);
            ...
            h_outside_ME_cos_theta_star->Fill(outside_ME_cos_theta_star, weight_1);
        } else{
            h2_invMass_ME_lambda_us_lambda_us->Fill(fourmoment_ME_lambda_us_1[i].M(), fourmoment_ME_lambda_us_2[i].M(), weight_1);

            h2_cut_ME_L0_L0_p1pt_p2pt_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Pt(), fourmoment_ME_anti_proton_us_2[i].Pt(), weight_1);
            h2_cut_ME_L0_L0_p1eta_p2eta_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Eta(), fourmoment_ME_anti_proton_us_2[i].Eta(), weight_1);
            h2_cut_ME_L0_L0_p1phi_p2phi_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Phi(), fourmoment_ME_anti_proton_us_2[i].Phi(), weight_1);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_us_3.size(); ++i){
        ...
        h2_no_cut_invMass_ME_lambda_us_lambda_ls->Fill(fourmoment_ME_lambda_us_3[i].M(), fourmoment_ME_lambda_ls_3[i].M(), weight_2);

        h2_no_cut_check_ME_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_3[i].Pt(), fourmoment_ME_proton_ls_3[i].Pt(), weight_2);
        h2_no_cut_check_ME_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_3[i].Eta(), fourmoment_ME_proton_ls_3[i].Eta(), weight_2);
        h2_no_cut_check_ME_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_us_3[i].Phi(), fourmoment_ME_proton_ls_3[i].Phi(), weight_2);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_us_lambda_ls->Fill(fourmoment_ME_lambda_us_3[i].M(), fourmoment_ME_lambda_ls_3[i].M(), weight_2);

            h2_cut_outside_ME_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_3[i].Pt(), fourmoment_ME_proton_ls_3[i].Pt(), weight_2);
            h2_cut_outside_ME_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_3[i].Eta(), fourmoment_ME_proton_ls_3[i].Eta(), weight_2);
            h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_us_3[i].Phi(), fourmoment_ME_proton_ls_3[i].Phi(), weight_2);
            ...
            h_outside_ME_cos_theta_star2->Fill(outside_ME_cos_theta_star2, weight_2);
        } else{
            h2_invMass_ME_lambda_us_lambda_ls->Fill(fourmoment_ME_lambda_us_3[i].M(), fourmoment_ME_lambda_ls_3[i].M(), weight_2);

            h2_cut_ME_L0_L0_p1pt_p2pt_US_LS->Fill(fourmoment_ME_proton_us_3[i].Pt(), fourmoment_ME_proton_ls_3[i].Pt(), weight_2);
            h2_cut_ME_L0_L0_p1eta_p2eta_US_LS->Fill(fourmoment_ME_proton_us_3[i].Eta(), fourmoment_ME_proton_ls_3[i].Eta(), weight_2);
            h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->Fill(fourmoment_ME_proton_us_3[i].Phi(), fourmoment_ME_proton_ls_3[i].Phi(), weight_2);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_bar_us_1.size(); ++i) {
        ...
        h2_no_cut_invMass_ME_lambda_bar_us_lambda_bar_us->Fill(fourmoment_ME_lambda_bar_us_1[i].M(), fourmoment_ME_lambda_bar_us_2[i].M(), weight_6);

        h2_no_cut_check_ME_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Pt(), fourmoment_ME_anti_proton_us_2[i].Pt(), weight_6);
        h2_no_cut_check_ME_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Eta(), fourmoment_ME_anti_proton_us_2[i].Eta(), weight_6);
        h2_no_cut_check_ME_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Phi(), fourmoment_ME_anti_proton_us_2[i].Phi(), weight_6);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->Fill(fourmoment_ME_lambda_bar_us_1[i].M(), fourmoment_ME_lambda_bar_us_2[i].M(), weight_6);

            h2_cut_outside_ME_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Pt(), fourmoment_ME_anti_proton_us_2[i].Pt(), weight_6);
            h2_cut_outside_ME_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Eta(), fourmoment_ME_anti_proton_us_2[i].Eta(), weight_6);
            h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Phi(), fourmoment_ME_anti_proton_us_2[i].Phi(), weight_6);
            ...
            h_outside_ME_cos_theta_star5->Fill(outside_ME_cos_theta_star5, weight_6);
        } else{
            h2_invMass_ME_lambda_bar_us_lambda_bar_us->Fill(fourmoment_ME_lambda_bar_us_1[i].M(), fourmoment_ME_lambda_bar_us_2[i].M(), weight_6);

            h2_cut_ME_L0bar_L0bar_p1pt_p2pt_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Pt(), fourmoment_ME_anti_proton_us_2[i].Pt(), weight_6);
            h2_cut_ME_L0bar_L0bar_p1eta_p2eta_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Eta(), fourmoment_ME_anti_proton_us_2[i].Eta(), weight_6);
            h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_US->Fill(fourmoment_ME_anti_proton_us_1[i].Phi(), fourmoment_ME_anti_proton_us_2[i].Phi(), weight_6);
    ...
    for (size_t i = 0; i < fourmoment_ME_lambda_bar_us_6.size(); ++i) {
        ...
        h2_no_cut_invMass_ME_lambda_bar_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_bar_us_6[i].M(), fourmoment_ME_lambda_bar_ls_6[i].M(), weight_7);

        h2_no_cut_check_ME_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Pt(), fourmoment_ME_anti_proton_ls_6[i].Pt(), weight_7);
        h2_no_cut_check_ME_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Eta(), fourmoment_ME_anti_proton_ls_6[i].Eta(), weight_7);
        h2_no_cut_check_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Phi(), fourmoment_ME_anti_proton_ls_6[i].Phi(), weight_7);
        ...
        double delta_R_Threshold = 0.93;
        if (delta_R > delta_R_Threshold){
            h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_bar_us_6[i].M(), fourmoment_ME_lambda_bar_ls_6[i].M(), weight_7);

            h2_cut_outside_ME_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Pt(), fourmoment_ME_anti_proton_ls_6[i].Pt(), weight_7);
            h2_cut_outside_ME_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Eta(), fourmoment_ME_anti_proton_ls_6[i].Eta(), weight_7);
            h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Phi(), fourmoment_ME_anti_proton_ls_6[i].Phi(), weight_7);
            ...
            h_outside_ME_cos_theta_star6->Fill(outside_ME_cos_theta_star6, weight_7);
        } else{
            h2_invMass_ME_lambda_bar_us_lambda_bar_ls->Fill(fourmoment_ME_lambda_bar_us_6[i].M(), fourmoment_ME_lambda_bar_ls_6[i].M(), weight_7);

            h2_cut_ME_L0bar_L0bar_p1pt_p2pt_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Pt(), fourmoment_ME_anti_proton_ls_6[i].Pt(), weight_7);
            h2_cut_ME_L0bar_L0bar_p1eta_p2eta_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Eta(), fourmoment_ME_anti_proton_ls_6[i].Eta(), weight_7);
            h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Fill(fourmoment_ME_anti_proton_us_6[i].Phi(), fourmoment_ME_anti_proton_ls_6[i].Phi(), weight_7);
    ...
    c31->cd(1);
    int binMinX_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_us->GetXaxis()->FindBin(minX_ME_2);
    int binMaxX_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_us->GetXaxis()->FindBin(maxX_ME_2);
    int binMinY_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_us->GetYaxis()->FindBin(minY_ME_2);
    int binMaxY_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_us_lambda_bar_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_us_lambda_bar_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_us_lambda_bar_us->Draw("SURF2");
    h2_invMass_ME_lambda_us_lambda_bar_us->SetTitle("US-US ME L0-L0bar pairs inside #DeltaR = 0.93");

    c31->cd(2);
    binMinX_ME_2 = h2_invMass_ME_lambda_us_lambda_us->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_ME_lambda_us_lambda_us->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_ME_lambda_us_lambda_us->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_ME_lambda_us_lambda_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_us_lambda_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_us_lambda_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_ME_lambda_us_lambda_us->Draw("SURF2");
    h2_invMass_ME_lambda_us_lambda_us->SetTitle("US-US ME L0-L0 pairs inside #DeltaR = 0.93");

    c31->cd(3);
    binMinX_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_ME_lambda_bar_us_lambda_bar_us->Draw("SURF2");
    h2_invMass_ME_lambda_bar_us_lambda_bar_us->SetTitle("US-US ME L0bar-L0bar pairs inside #DeltaR = 0.93");

    c31->cd(4);
    binMinX_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_ME_lambda_us_lambda_bar_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_us_lambda_bar_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_us_lambda_bar_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_ME_lambda_us_lambda_bar_ls->Draw("SURF2");
    h2_invMass_ME_lambda_us_lambda_bar_ls->SetTitle("US-LS ME L0-L0bar pairs inside #DeltaR = 0.93");

    c31->cd(5);
    binMinX_ME_2 = h2_invMass_ME_lambda_us_lambda_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_ME_lambda_us_lambda_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_ME_lambda_us_lambda_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_ME_lambda_us_lambda_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_us_lambda_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_us_lambda_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_ME_lambda_us_lambda_ls->Draw("SURF2");
    h2_invMass_ME_lambda_us_lambda_ls->SetTitle("US-LS ME L0-L0 pairs inside #DeltaR = 0.93");

    c31->cd(6);
    binMinX_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_ME_lambda_bar_us_lambda_bar_ls->Draw("SURF2");
    h2_invMass_ME_lambda_bar_us_lambda_bar_ls->SetTitle("US-LS ME L0bar-L0bar pairs inside #DeltaR = 0.93");
    ...
    c32->cd(1);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_bar_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_bar_us->Draw("SURF2");
    h2_invMass_outside_ME_lambda_us_lambda_bar_us->SetTitle("US-US ME L0-L0bar pairs outside #DeltaR = 0.93");

    c32->cd(2);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_us->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_us->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_us->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_us_lambda_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_us->Draw("SURF2");
    h2_invMass_outside_ME_lambda_us_lambda_us->SetTitle("US-US ME L0-L0 pairs outside #DeltaR = 0.93");

    c32->cd(3);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->Draw("SURF2");
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_us->SetTitle("US-US ME L0bar-L0bar pairs outside #DeltaR = 0.93");

    c32->cd(4);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_bar_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_bar_ls->Draw("SURF2");
    h2_invMass_outside_ME_lambda_us_lambda_bar_ls->SetTitle("US-LS ME L0-L0bar pairs outside #DeltaR = 0.93");

    c32->cd(5);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_us_lambda_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_us_lambda_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_outside_ME_lambda_us_lambda_ls->Draw("SURF2");
    h2_invMass_outside_ME_lambda_us_lambda_ls->SetTitle("US-LS ME L0-L0 pairs outside #DeltaR = 0.93");

    c32->cd(6);
    binMinX_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->FindBin(minX_ME_2);
    binMaxX_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->FindBin(maxX_ME_2);
    binMinY_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->FindBin(minY_ME_2);
    binMaxY_ME_2 = h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->FindBin(maxY_ME_2);

    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetXaxis()->SetRange(binMinX_ME_2, binMaxX_ME_2);
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->GetYaxis()->SetRange(binMinY_ME_2, binMaxY_ME_2);
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->Draw("SURF2");
    h2_invMass_outside_ME_lambda_bar_us_lambda_bar_ls->SetTitle("US-LS ME L0bar-L0bar pairs outside #DeltaR = 0.93");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS ME L0_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0 Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0 Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US ME L0_L0 Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0 Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0 Pairs (no cuts, check)");
    ...
    c35->cd(6);
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS ME L0_L0 Pairs (no cuts, check)");
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_no_cut_check_ME_L0_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h2_no_cut_check_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS ME L0bar_L0bar Pairs (no cuts, check)");
    ...
    h_outside_ME_cos_theta_star3->SetTitle("Lambda - Lambda Bar Angular Correlation");
    ...
    h_outside_ME_cos_theta_star->SetTitle("Lambda - Lambda Angular Correlation");
    ...
    h_outside_ME_cos_theta_star5->SetTitle("Lambda Bar - Lambda Bar Angular Correlation");
    ...
    h_cos_theta_star3->SetMarkerColor(kBlue);
    h_cos_theta_star3->Draw("PE"); // Draw with error bars
    h_cos_theta_star3->SetTitle("Lambda - Lambda Bar Angular Correlation in Delta_R = 0.93");
    h_cos_theta_star4->SetMarkerStyle(20);
    h_cos_theta_star4->SetLineColor(kRed);
    h_cos_theta_star4->SetMarkerColor(kRed);
    h_cos_theta_star4->Draw("same PE"); // Draw with error bars
    ...
    h_ME_cos_theta_star3->SetTitle("Lambda - Lambda Bar Angular Correlation in Delta_R = 0.93");
    ...
    h_cos_theta_star->SetMarkerColor(kBlue);
    h_cos_theta_star->Draw("PE");
    h_cos_theta_star->SetTitle("Lambda - Lambda Angular Correlation in Delta_R = 0.93");
    h_cos_theta_star2->SetLineColor(kRed);
    h_cos_theta_star2->SetMarkerStyle(20);
    h_cos_theta_star2->SetMarkerColor(kRed);
    h_cos_theta_star2->Draw("same PE");
    ...
    h_ME_cos_theta_star->SetTitle("Lambda - Lambda Angular Correlation in Delta_R = 0.93");
    h_ME_cos_theta_star2->SetLineColor(kRed);
    ...
    h_cos_theta_star5->SetMarkerColor(kBlue);
    h_cos_theta_star5->Draw("PE"); // Draw with error bars
    h_cos_theta_star5->SetTitle("Lambda Bar - Lambda Bar Angular Correlation in Delta_R = 0.93");
    h_cos_theta_star6->SetLineColor(kRed);
    h_cos_theta_star6->SetMarkerStyle(20);
    h_cos_theta_star6->SetMarkerColor(kRed);
    h_cos_theta_star6->Draw("same PE"); // Draw with error bars
    ...
    h_ME_cos_theta_star5->SetTitle("Lambda Bar - Lambda Bar Angular Correlation in Delta_R = 0.93");
    h_ME_cos_theta_star6->SetLineColor(kRed);
    ...
    h_outside_cos_theta_star3->SetTitle("Lambda - Lambda Bar Angular Correlation outside Delta_R = 0.93");
    h_outside_cos_theta_star4->SetMarkerStyle(20);
    h_outside_cos_theta_star4->SetLineColor(kRed);
    h_outside_cos_theta_star4->SetMarkerColor(kRed);
    ...
    h_outside_ME_cos_theta_star3->SetTitle("Lambda - Lambda Bar Angular Correlation outside Delta_R = 0.93");
    ...
    h_outside_cos_theta_star->SetMarkerColor(kBlue);
    h_outside_cos_theta_star->Draw("PE");
    h_outside_cos_theta_star->SetTitle("Lambda - Lambda Angular Correlation outside Delta_R = 0.93");
    h_outside_cos_theta_star2->SetLineColor(kRed);
    h_outside_cos_theta_star2->SetMarkerStyle(20);
    h_outside_cos_theta_star2->SetMarkerColor(kRed);
    h_outside_cos_theta_star2->Draw("same PE");
    ...
    h_outside_ME_cos_theta_star->SetTitle("Lambda - Lambda Angular Correlation outside Delta_R = 0.93");
    h_outside_ME_cos_theta_star2->SetLineColor(kRed);
    ...
    h_outside_cos_theta_star5->SetTitle("Lambda Bar - Lambda Bar Angular Correlation outside Delta_R = 0.93");
    h_outside_cos_theta_star6->SetLineColor(kRed);
    h_outside_cos_theta_star6->SetMarkerStyle(20);
    h_outside_cos_theta_star6->SetMarkerColor(kRed);
    ...
    h_outside_ME_cos_theta_star5->SetTitle("L0bar - L0bar Angular Correlation outside Delta_R = 0.93");
    h_outside_ME_cos_theta_star6->SetLineColor(kRed);
    ...
    h2_cut_ME_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0bar Pairs inside #DeltaR = 0.93");
    ...
    c40->cd(6);
    h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0bar Pairs inside #DeltaR = 0.93");
    h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_ME_L0_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_cut_ME_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0_L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0 Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0 Pairs inside #DeltaR = 0.93");
    h2_cut_ME_L0_L0_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_eta");
    h2_cut_ME_L0_L0_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_eta");

    c41->cd(6);
    h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0 Pairs inside #DeltaR = 0.93");
    h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_ME_L0_L0_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_cut_ME_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0bar_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0bar_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0bar_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0bar_L0bar Pairs inside #DeltaR = 0.93");
    ...
    h2_cut_ME_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0bar_L0bar Pairs inside #DeltaR = 0.93");
    ...
    c42->cd(6);
    h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar_L0bar Pairs inside #DeltaR = 0.93");
    h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_cut_outside_ME_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0bar Pairs outside #DeltaR = 0.93");
    ...
    c43->cd(6);
    h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0bar Pairs outside #DeltaR = 0.93");
    h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_outside_ME_L0_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_cut_outside_ME_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0_L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0_L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0_L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0_L0 Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0_L0 Pairs outside #DeltaR = 0.93");
    ...
    c44->cd(6);
    h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0_L0 Pairs outside #DeltaR = 0.93");
    h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_outside_ME_L0_L0_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_cut_outside_ME_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US ME L0bar_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US ME L0bar_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0bar_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS ME L0bar_L0bar Pairs outside #DeltaR = 0.93");
    ...
    h2_cut_outside_ME_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-LS ME L0bar_L0bar Pairs outside #DeltaR = 0.93");
    ...
    c45->cd(6);
    h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-LS L0bar_L0bar Pairs outside #DeltaR = 0.93");
    h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_phi");
    h2_cut_outside_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_phi");
    ...
    h2_recombined_ME_L0_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c46->cd(3);
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c46->cd(4);
    h2_recombined_ME_L0_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_ME_L0_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0bar_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c46->cd(6);
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");
    ...
    h2_recombined_ME_L0_L0_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c47->cd(3);
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c47->cd(4);
    h2_recombined_ME_L0_L0_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_ME_L0_L0_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0-L0 Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c47->cd(6);
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0-L0 Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0_L0_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    std::cout << "Canvas 47 Complete" << std::endl;

    std::unique_ptr<TCanvas> c48(new TCanvas("c48", "Canvas 48", 1800, 900));
    c48->Divide(3, 2);
    ...
    h2_recombined_ME_L0bar_L0bar_p1pt_p2pt_US_US->SetTitle("Pt- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_US->SetTitle("Eta- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c48->cd(3);
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_US->Draw("COLZ");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_US->SetTitle("Phi- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_US->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_US->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c48->cd(4);
    h2_recombined_ME_L0bar_L0bar_p1pt_p2pt_US_LS->Draw("COLZ");
    h2_recombined_ME_L0bar_L0bar_p1pt_p2pt_US_LS->SetTitle("Pt- US-LS L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    ...
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_LS->SetTitle("Eta- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0bar_L0bar_p1eta_p2eta_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    c48->cd(6);
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_LS->Draw("COLZ");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_LS->SetTitle("Phi- US-US L0bar-L0bar Pairs inside and outside #DeltaR = 0.93");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetXaxis()->SetTitle("p1_pt [GeV/c]");
    h2_recombined_ME_L0bar_L0bar_p1phi_p2phi_US_LS->GetYaxis()->SetTitle("p2_pt [GeV/c]");

    std::cout << "Canvas 48 Complete" << std::endl;

    proton_output_file_2sig->cd();
    ...
    proton_output_file_2sig->Write();
    proton_output_file_2sig->Close();
